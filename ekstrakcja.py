...
# urllib jest czescia standardowej biblioteki Pythona. Zawiera funkcje służące do pobierania informacji o danych, a także pobierania samych danych z internetu
#najczestszym zastosowaniem dla re jest poszukiwanie tekstow
# time potrzebne jest do manipulowania godzinami i datami

url = urllib.urlopen('http://www.meteoprog.pl/pl/weather/Gdynia/')
url_tekst = url.read()
...
wyrazenie2 = 'd</span><span class="colorNoBold">(.+?)</span>' #1197 linia
